...
RubyZoho.configure do |config|
  config.api_key = '6a573c09ed6306e2d5808816172e863c'
  ...
  #/home/puneet/Puneet/RubyZoho_App/app/controllers/rubyzohos_controller.rb Currently only Quotes are supported
end