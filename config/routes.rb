Rails.application.routes.draw do
  ...
  match '/blm5',   to: 'properties#blm5', via: 'get'
  ...
  match '/upload_blm_zoopla',   to: 'properties#upload_blm_zoopla', via: 'get'
  ...
  match '/seller_prospective',   to: 'properties#properties_seller_prospective',   via: 'get'
  ...
  match '/key_book',   to: 'phones#key_book',   via: 'get'
end
