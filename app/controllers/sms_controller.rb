class SmsController < ApplicationController
	...
	def send_sms
		...
		@user = User.where("mobile ilike ? OR phone ilike ? OR mobile ilike ? OR phone ilike ?", params[:originator],params[:originator], params[:originator].gsub(/^44/, "0"), params[:originator].gsub(/^44/, "0")).first
